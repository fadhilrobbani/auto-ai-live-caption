...
OFFLINE_MODEL_CATALOG: List[CatalogModel] = [
    CatalogModel(
        ...
        description="Lightest & fastest English model. Best choice for low-spec laptops.",
    ...
    CatalogModel(
        ...
        description="Lightest multilingual model (supports Indonesian, English, Japanese, etc.).",
    ...
    CatalogModel(
        ...
        description="Standard balanced model for multilingual live captioning.",
        speed_rating="⚡⚡⚡ Balanced (~300-450ms)",
        is_multilingual=True,
    ...
    CatalogModel(
        ...
        description="English-optimized base model with high fidelity.",
        speed_rating="⚡⚡⚡ Balanced (~250-350ms)",
        is_multilingual=False,
    ...
    CatalogModel(
        ...
        description="Knowledge-distilled English model; ultra fast with small-tier accuracy.",
        speed_rating="⚡⚡⚡⚡ Fast Distilled",
        is_multilingual=False,
    ...
    CatalogModel(
        ...
        description="Higher accuracy multilingual model; recommended with multi-core CPU.",
        speed_rating="⚡⚡ High Accuracy",
        is_multilingual=True,
